...
with open('../docs/MultiHEad_testing.json', 'r') as f:
    results = json.load(f)

# Extract predictions and ground truths
wire_pred = results['predicted_wire']
wire_true = results['wire_truth']
terminal_pred = results['predicted_terminal']
terminal_true = results['terminal_truth']
...
evaluate_and_plot(terminal_true, terminal_pred, 'terminal')
