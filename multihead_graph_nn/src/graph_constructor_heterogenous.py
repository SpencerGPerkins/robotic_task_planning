...
class GraphHeterogenous:
    def __init__(self, vision_in, llm_in, label_in=None, global_node_offset=0):
        ...
        self.actions = ["pick", "insert", "lock", "putdown"] # Possible Predicted actions (robot prims + wait for non-action)
...
# vision_data = "../synthetic_data/5_class/vision/sample_0.json"
# llm_data = "../synthetic_data/5_class/llm/sample_0.json"
# label_data = "../synthetic_data/5_class/labels/sample_0.json"

# G = GraphHeterogenous(vision_data, llm_data, label_in=label_data)


# print(f"WIRES: {G.wire_dict}\n")
# print(f"TERMINALS: {G.terminal_dict}\n")
# print(f"LLM: {G.target_info}\n")
# print(f"LABELS: {G.label_info}\n")
# G.node_feature_encoding()
# print(f"Wire encoding len: {len(G.X_wires)}\n")
# print(f"Wire encodings: {G.X_wires}\n")
# print(f"Terminal encoding len: {len(G.X_terminals)}\n")
# print(f"Terminal encodings: {G.X_terminals}\n")

# G.edge_feature_encoding()
# print(f"Edge Features: {G.edge_attr}")