...
class Graph:
    ...
    def __init__(self, vision_in, llm_in, label_in=None):
        ...
        #         self.y_target_wire = (label_data["target_wire"]["coordinates"])
        #         _, tar_term = label_data["target_terminal"]["name"].split("_")
        #         self.y_target_terminal = (label_data["target_terminal"]["coordinates"])
